...
cleaned_crime_data$homicide_or_shooting <- str_replace(
  cleaned_crime_data$homicide_or_shooting, "homicide_2018", "homicide")
cleaned_crime_data$homicide_or_shooting <- str_replace(
  cleaned_crime_data$homicide_or_shooting, "homicide_2019", "homicide")
cleaned_crime_data$homicide_or_shooting <- str_replace(
  cleaned_crime_data$homicide_or_shooting, "homicide_2020", "homicide")
cleaned_crime_data$homicide_or_shooting <- str_replace(
  cleaned_crime_data$homicide_or_shooting, "homicide_2021", "homicide")
cleaned_crime_data$homicide_or_shooting <- str_replace(
  cleaned_crime_data$homicide_or_shooting, "homicide_2022", "homicide")
cleaned_crime_data$homicide_or_shooting <- str_replace(
  cleaned_crime_data$homicide_or_shooting, "homicide_2023", "homicide")

cleaned_crime_data$homicide_or_shooting <- str_replace(
  cleaned_crime_data$homicide_or_shooting, "shooting_2018", "shooting")
cleaned_crime_data$homicide_or_shooting <- str_replace(
  cleaned_crime_data$homicide_or_shooting, "shooting_2019", "shooting")
cleaned_crime_data$homicide_or_shooting <- str_replace(
  cleaned_crime_data$homicide_or_shooting, "shooting_2020", "shooting")
cleaned_crime_data$homicide_or_shooting <- str_replace(
  cleaned_crime_data$homicide_or_shooting, "shooting_2021", "shooting")
cleaned_crime_data$homicide_or_shooting <- str_replace(
  cleaned_crime_data$homicide_or_shooting, "shooting_2022", "shooting")
cleaned_crime_data$homicide_or_shooting <- str_replace(
  cleaned_crime_data$homicide_or_shooting, "shooting_2023", "shooting")
